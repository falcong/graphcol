...
#File programma
OBJECT = main.o routines.o node.o graph.o nodesList.o pnode.o pnodesList.o graphics.o
SOURCES = $(INC) $(SRC)
INC =	routines.h node.h graph.h defs.h nodesList.h pnode.h pnodesList.h
SRC = main.c routines.c node.c graph.c nodesList.c pnode.c pnodesList.c graphics.c
